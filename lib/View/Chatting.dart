...
class _ChattingState extends State<Chatting> {
  ...
  SendMessage(String msg) async {
    var send = FirebaseDatabase.instance
        .reference()
        .child("chats")
        .child(uid)
        .child(widget.contactID);
    var receive = FirebaseDatabase.instance
        .reference()
        .child("chats")
        .child(widget.contactID)
        .child(uid);
    ...
    if (msg != "") {
      send.push().set({'msg': msg, 'method': 'send'});
  ...
  ShowOfferWidget() async {
    ...
    showModalBottomSheet(
        ...
        builder: (BuildContext builder) {
          if ((widget.prodID == null || widget.prodID == "") &&
              isBuyer == false &&
              isSeller == false) {
            return Container(
          ...
          } else if (widget.prodID != "" && widget.prodID != null ||
              (isSeller == false && isBuyer == true) ||
                                      ...
                                      if (_formKey.currentState.validate()) {
                                        if (offerStatus == "rejected" ||
                                          ...
                                          _scaffoldKey.currentState
                                              .showSnackBar(SnackBar(
                                                  content: Text(
                                                      'Seller already accepted your offer')));
                                        } else {
                                          _scaffoldKey.currentState
                                              .showSnackBar(SnackBar(
                                                  content: Text(
